...
svg.append('linearGradient')
    ...
    .data([{
            offset: "10%",
            color: erColors("revenue")
        },
        {
            offset: "90%",
            color: fundColors("General Fund")
        }
    ])
    .enter().append("stop")
...
svg.append('linearGradient')
    ...
    .data([{
        ...
        {
            offset: "90%",
            color: fundColors("Non-discretionary funds")
        }
    ])
    .enter().append("stop")
    .attr("offset", function (d) {
...
function data_wrangle(dataset, fy) {
    ...
    rev_order = [
        ...
        "Contribute-Group/Individual",
        "Vendor Project 98",
        "Rent",
        "Contribute-Group/Individual",
        "Transfer MNPS Programs"
    ];
    ...
    exp_order = [
        ...
        // "Debt Service & Misc."
        "Transfer Guaranteed Pension",
        "Employer Group Health",
        "Employer Dental Group",
        "Transfer Operational",
        "Transfer IOD Pensioner",
        "Insurance-Unemployment Comp",
        "Employer Group Life"
    ];
    expdivs = d3.nest()
        .key(function (d) {
